        ...
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center h-full">
          ...
          <div className="text-left md:w-1/2 mb-8 md:mb-0">
            ...
            <p className="text-gray-500 mt-4">
              Discover a world of delicious and nutritious meals designed to
            ...
            <div className="mt-6 flex space-x-4">
              ...
              <button
                ...
                className="border border-green-600 text-green-600 px-6 py-2 rounded-lg hover:bg-green-100 transition-all"
              >
                Place an order
              </button>
            </div>
