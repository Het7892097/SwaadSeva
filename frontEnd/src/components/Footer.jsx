      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="mb-4">Subscribe our newsletter and get discount 25% off</p>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-pink-500"><i className="fab fa-pinterest"></i></a>
              ...
              <a href="#" className="text-pink-400"><i className="fab fa-instagram"></i></a>
          ...
          <div>
            ...
            <p className="mb-2 flex items-start">
              <span className="mr-2 text-green-600">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 10l7-7m0 0l7 7M10 3v14" />
                </svg>
              </span>
             9825------
            </p>
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-2">
              {/* Image placeholders */}
              <img src="https://www.foodiesfeed.com/wp-content/uploads/2023/06/burger-with-melted-cheese.jpg" alt="gallery" className="w-full h-20 object-cover rounded-md" />
              <img src="https://www.foodiesfeed.com/wp-content/uploads/2023/06/burger-with-melted-cheese.jpg" alt="gallery" className="w-full h-20 object-cover rounded-md" />
              <img src="https://www.foodiesfeed.com/wp-content/uploads/2023/06/burger-with-melted-cheese.jpg" alt="gallery" className="w-full h-20 object-cover rounded-md" />
              <img src="https://www.foodiesfeed.com/wp-content/uploads/2023/06/burger-with-melted-cheese.jpg" alt="gallery" className="w-full h-20 object-cover rounded-md" />
              <img src="https://www.foodiesfeed.com/wp-content/uploads/2023/06/burger-with-melted-cheese.jpg" alt="gallery" className="w-full h-20 object-cover rounded-md" />
