...
const OrdersToday = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:3050/api/v1/user/orders", {
        headers: {
  ...
  const handleCheckboxChange = (orderId) => {
    ...
    axios
      .patch(
        "http://localhost:3050/api/v1/user/completer",
        { orderId },
        {
          headers: {
    ...
    <>
      ...
      <div className="flex mt-8 flex-col">
        <h2 className="text-3xl font-semibold mb-4">
          Orders for Today - {new Date().toLocaleDateString()}
        </h2>
                        ...
                        <tr key={order.orderId}>
                          <td className="py-3 ps-4">
                            <div className="flex items-center h-5">
                              ...
                              />
                              <label
                                htmlFor={`hs-table-pagination-checkbox-${order.orderId}`}
                                className="sr-only"
                              >
                                Checkbox
                              </label>
                  ...
                  >
                    ...
                    {[
                      ...
                      <button
                        ...
                        className={`min-w-[40px] p-2.5 inline-flex justify-center items-center text-sm rounded-full ${
