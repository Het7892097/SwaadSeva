...
const OrdersToday = () => {
  ...
  const orders = [
    { orderId: 1, orderedTime: "2024-09-25 12:30", orderedItems: [{ food: "Burger", quantity: 2 }, { food: "Fries", quantity: 1 }] },
    { orderId: 2, orderedTime: "2024-09-25 12:45", orderedItems: [{ food: "Pizza", quantity: 1 }] },
    { orderId: 3, orderedTime: "2024-09-25 13:00", orderedItems: [{ food: "Pasta", quantity: 3 }] },
    { orderId: 4, orderedTime: "2024-09-25 13:15", orderedItems: [{ food: "Salad", quantity: 1 }, { food: "Soup", quantity: 2 }] },
    { orderId: 5, orderedTime: "2024-09-25 13:30", orderedItems: [{ food: "Tacos", quantity: 4 }] },
    { orderId: 6, orderedTime: "2024-09-25 13:45", orderedItems: [{ food: "Sushi", quantity: 5 }] },
    { orderId: 7, orderedTime: "2024-09-25 14:00", orderedItems: [{ food: "Steak", quantity: 1 }] },
    { orderId: 8, orderedTime: "2024-09-25 14:15", orderedItems: [{ food: "Sandwich", quantity: 2 }] },
    { orderId: 9, orderedTime: "2024-09-25 14:30", orderedItems: [{ food: "Ice Cream", quantity: 3 }] },
    { orderId: 10, orderedTime: "2024-09-25 14:45", orderedItems: [{ food: "Cupcakes", quantity: 6 }] },
  ];
