          ...
          <div className="space-y-6">
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <motion.button
                ...
                className={`mt-2 w-full bg-purple-600 text-white py-2 px-4 rounded-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-opacity-50 transition duration-300 ${selectedPayment === "luck" && isLoading ? "opacity-50 cursor-not-allowed" : ""}`}
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <motion.button
                ...
                className={`w-full bg-green-600 text-white py-2 px-4 rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 transition duration-300 ${selectedPayment === "cashfree" && isLoading ? "opacity-50 cursor-not-allowed" : ""}`}
