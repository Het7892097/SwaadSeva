...
const {userCreator,userLogger,userRemover,userUpdater,productOrder, userDetailer, orderGetter, orderCompleter}=require("../controllers/userController");
...
//route: api/v1/user/completer
router.patch("/completer",(req,res,next)=>{
    console.log("Through Order-completion route");
    next();
},orderCompleter)//userMiddleware,adminMiddleware,
