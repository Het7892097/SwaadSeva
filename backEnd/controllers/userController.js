const { creator, remover, updater, logger,orderer, detailer, orderLister,completer } = require("../repository/userRepo");
...
const orderCompleter = async (req, res) => {
  console.log("completer-controller");

    const orderId = req.body.orderId; // Assuming orderId is passed as a URL parameter
  
    try {
      // Call the completer function to update the order
...
module.exports = {
    userCreator, userLogger, userRemover, userUpdater,productOrder,userDetailer,orderGetter, orderCompleter
}